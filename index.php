...
<head>
 ...
 <script src ="https://maps.googleapis.com/maps/api/js?key=AIzaSyDrmqYnjpn5plJc85pjTTmafSMI2H9S0-M&callback=initMap"></script>
...
<footer class="container-fluid" >
  <div class="row">
     ...
     <div class="col-sm-4">                  
        <a href="#">&nbsp;<span class="fa fa-github" style="font-size:25px;color:white;"></span>&nbsp;&nbsp;<b>Fork </a> </b>  
    </div>
    <div class="col-sm-4">              
    </div>
     <div class="col-sm-4"  > 
        <b >&nbsp;&nbsp;<i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;</p></i></b>     
     </div> 
